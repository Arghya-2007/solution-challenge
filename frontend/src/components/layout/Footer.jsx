    ...
    return (
        <Box
            ...
            sx={{
                ...
                background: G.dark,
                pt: { xs: 6, sm: 8, md: 10 }, pb: { xs: 4, sm: 4.5, md: 5 },
            }}>
            <GlobalStyles styles={{
            ...
            <Box sx={{ maxWidth: 1240, mx: 'auto', px: { xs: 2.5, md: 5 }, position: 'relative', zIndex: 1 }}>
                ...
                <Box sx={{
                    ...
                    gap: { xs: 3, sm: 4 }, mb: { xs: 5, sm: 6, md: 8 },
                    ...
                    <Box>
                        ...
                        <Typography sx={{
                            fontFamily: "'Plus Jakarta Sans',sans-serif",
                            fontWeight: 600, fontSize: { xs: '0.85rem', sm: '0.9rem', md: '1rem' },
                    ...
                    {/* Stats mini-row */}
                    <Box sx={{
                        display: 'flex', gap: { xs: 1.5, sm: 2, md: 3 },
                        ...
                        {STATS.map((s, i) => (
                            <Box key={i} sx={{
                                ...
                                <Typography sx={{
                                    fontFamily: "'Syne',sans-serif",
                                    fontWeight: 900, fontSize: { xs: '1.1rem', sm: '1.2rem', md: '1.3rem' },
                ...
                {/* ══ DIVIDER ══════════════════════════════════════════════════ */}
                <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 2, sm: 3 }, mb: { xs: 5, sm: 6, md: 8 } }}>
                ...
                <Box sx={{
                    display: 'grid',
                    gridTemplateColumns: { xs: '1fr', sm: 'repeat(3, 1fr)', md: '2fr 1fr 1fr 1fr' },
                    gap: { xs: 4, sm: 5, md: 6 },
                    mb: { xs: 6, sm: 7, md: 9 },
                }}>
                    {/* Brand blurb column */}
                    <Box sx={{ gridColumn: { xs: '1 / -1', sm: '1 / -1', md: '1' } }}>
                        <Typography sx={{
                            fontFamily: "'Syne',sans-serif",
