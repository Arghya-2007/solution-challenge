...
const TEMPLATES = [
    { id: 'hiring',      icon: <WorkIcon fontSize="large" sx={{ color: G.blue }} />,        title: 'Hiring & Recruitment', subtext: 'Detects gender, race & education bias in shortlisting', color: G.blue  },
    { id: 'performance', icon: <AssessmentIcon fontSize="large" sx={{ color: G.red }} />,   title: 'Performance Reviews',  subtext: 'Detects age & gender bias in evaluation scores',        color: G.red   },
    { id: 'promotions',  icon: <TrendingUpIcon fontSize="large" sx={{ color: G.green }} />, title: 'Internal Promotions',  subtext: 'Detects demographic bias in career progression',        color: G.green },
];
...
export default function Landing() {
    ...
    useEffect(() => {
        runUploadRef.current = async () => {
            try {
                const res = file ? await uploadFile(file, setUploadProgress) : await uploadGoogleSheet(sheetUrl);
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        navigate('/analyze', { state: { data: res, template: selectedTemplate } });
                    }, 400);
                }, 1200);
            } catch (err) {
                setIsUploading(false);
                ...
                const errorMessage = serverMessage || err.message || "Error uploading dataset. Please try again.";
    ...
    const handleCardClick = useCallback(() => fileInputRef.current?.click(), []);
    const handleRemoveFile = useCallback(e => { e.stopPropagation(); setFile(null); }, []);
    ...
    const handleUploadClick = useCallback(() => {
        if (!user) {
            import('sweetalert2').then(({ default: Swal }) => {
                Swal.fire({
                    ...
                    text: 'Please sign in to upload and analyze datasets.',
        ...
        runUploadRef.current();
    }, [file, sheetUrl, user, navigate]);
    ...
    return (
        <Box sx={{
            ...
            <SEO title="EquiLens - AI Hiring Bias Detection" />
            <GlobalStyles styles={{
                '*, *::before, *::after': {
            ...
            <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2, px: { xs: 2, md: 4 }, flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                {/* ══ HERO ══════════════════════════════════════════════════════ */}
                <Box sx={{ textAlign: 'center', mt: { xs: 3, md: 9 }, mb: { xs: 7, md: 14 }, position: 'relative' }}>
                    ...
                    {isLoading ? (
                        ...
                        <motion.div initial={{ opacity: 0, y: -18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.5 }}>
                            ...
                            <Box sx={{
                                display: 'inline-flex', alignItems: 'center', gap: { xs: 1, sm: 1.5 },
                                px: { xs: 2, sm: 3 }, py: { xs: 1, sm: 1.3 }, borderRadius: 100, mb: 5,
                                ...
                                <Typography sx={{
                                    fontFamily: "'Plus Jakarta Sans',sans-serif",
                                    fontWeight: 800, fontSize: { xs: '0.7rem', sm: '0.82rem' }, color: G.blue, letterSpacing: '0.08em',
                                }}>
                    ...
                    {isLoading ? (
                        ...
                        <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.0 }}>
                            <Box sx={{
                                ...
                                flexWrap: 'wrap', pb: 1, px: { xs: 1, md: 0 },
                                position: 'relative', zIndex: 1,
                            }}>
                                {STATS.map((s, i) => (
                                    <motion.div key={i}
                ...
                {/* ══ UPLOAD CARDS ══════════════════════════════════════════════ */}
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: { xs: 3, md: 6 }, mb: { xs: 8, md: 20 } }}>
                    ...
                    {isLoading ? <Skeleton height={420} borderRadius={28} /> : (
                        <motion.div
                            ...
                            <TiltCard>
                                <Box sx={{
                                    height: '100%', position: 'relative', p: IS_PERF_MODE ? 0 : '1.5px', borderRadius: '30px',
                                    ...
                                    <SpotlightCard color={isDragging ? G.blue : file ? G.green : G.blue} sx={{ backgroundColor: 'rgba(255,255,255,0.6)', borderRadius: '28px' }}>
                                        ...
                                        sx={{
                                            p: { xs: 3, md: 5 }, minHeight: { xs: 300, md: 420 },
                                            display: 'flex', flexDirection: 'column',
                                            alignItems: 'center', justifyContent: 'center',
                                        ...
                                        <input type="file" hidden ref={fileInputRef} onClick={(e) => { e.target.value = null; }} onChange={e => setFile(e.target.files[0])} accept=".csv,.xlsx" />
                                        ...
                                        {file ? <AnimatedCheck size={100} color={G.green} /> : (
                                            <motion.div
                                                ...
                                                <Box sx={{
                                                    ...
                                                    alignItems: 'center', justifyContent: 'center', width: { xs: 110, md: 148 }, height: { xs: 110, md: 148 },
                                                }}>
                                                    ...
                                                    <CloudUploadIcon sx={{
                                                        fontSize: { xs: 54, md: 78 }, position: 'relative', zIndex: 2,
                                        ...
                                        <Typography sx={{
                                            fontFamily: "'Syne',sans-serif", fontWeight: 900,
                                            fontSize: { xs: '1.15rem', md: '1.82rem' },
                                            mt: { xs: 2, md: 3.5 }, textAlign: 'center',
                                        ...
                                        {file && (
                                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 3, width: '100%', maxWidth: { xs: '100%', sm: '320px' }, position: 'relative', zIndex: 10 }}>
                                                <MagneticBtn>
                                                ...
                                                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }} style={{ width: '100%' }}>
                                                    <Button fullWidth size="large" onClick={handleRemoveFile}
                                                            sx={{
                                                                fontFamily: "'Syne',sans-serif", fontWeight: 900,
                            ...
                            <TiltCard>
                                <Box sx={{
                                    ...
                                    <SpotlightCard color={G.green} sx={{ backgroundColor: 'rgba(255,255,255,0.6)', borderRadius: '28px' }}>
                                        ...
                                        <motion.div
                                            animate={IS_PERF_MODE ? {} : { y: [0, -10, 0], rotate: [-3, 3, -3] }}
                                            transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}>
                                            <Box sx={{ position: 'relative', width: { xs: 72, md: 86 }, height: { xs: 72, md: 86 }, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                ...
                                                <img
                                                    ...
                                                    alt="Google Sheets" width={72} height={72} loading="lazy"
                                                    style={{ filter: `drop-shadow(0 10px 18px ${G.green}55)`, position: 'relative', zIndex: 2, width: '100%', height: '100%' }}
                                                />
                                            </Box>
                                        </motion.div>

                                        <Typography sx={{ fontFamily: "'Syne',sans-serif", fontWeight: 900, fontSize: { xs: '1.25rem', md: '1.82rem' }, mt: { xs: 2, md: 3 }, mb: 0.5, color: '#202124', letterSpacing: '-0.02em' }}>
                                            Import via Sheets
                                        </Typography>
                                        ...
                                        <MagneticBtn>
                                            <Button variant="contained" fullWidth size="large"
                                                    ...
                                                    data-hover="true"
                                                    sx={{
                                                        py: { xs: 1.8, md: 2.2 }, borderRadius: '50px',
                                                        fontFamily: "'Syne',sans-serif", fontWeight: 900,
                                                        fontSize: { xs: '1rem', md: '1.12rem' }, textTransform: 'none',
                                                        background: `linear-gradient(90deg,${G.blue},${G.red},${G.yellow},${G.green},${G.blue})`,
                                                        backgroundSize: '300% 100%',
                                                        animation: IS_PERF_MODE ? 'none' : 'gradientFlow 4s ease infinite',
                ...
                {!isLoading && (
                    <Box sx={{
                        ...
                        mb: { xs: 5, md: 10 }, mt: { xs: -3, md: -10 }, px: 2,
                    }}>
                                    ...
                                    <TiltCard>
                                        ...
                                        <SpotlightCard color={tpl.color} borderRadius="28px">
                                            <Card elevation={0}
                                                  ...
                                                  data-hover="true"
                                                  sx={{
                                                      p: { xs: 3, md: 5 }, cursor: SHOW_CURSOR ? 'none' : 'auto', minHeight: { xs: 240, md: 280 },
                                                      display: 'flex', flexDirection: 'column',
                ...
                {/* ══ HOW IT WORKS ═════════════════════════════════════════════════ */}
                <Box sx={{ mb: { xs: 8, md: 16 }, px: { xs: 2, md: 0 } }}>
                    <motion.div
                        initial={{ opacity: 0, y: 24 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, margin: '-50px' }}
                        ...
                        <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 8 } }}>
                            <Box sx={{ position: 'relative', display: 'inline-block', mb: 1.5 }}>
                                <Typography sx={{
                                    ...
                                    letterSpacing: '-0.03em', color: '#202124',
                                }}>
                                    How It Works
                                </Typography>
                                <Box sx={{
                                    position: 'absolute', bottom: -5, left: '15%', right: '15%', height: 3,
                                    background: `linear-gradient(90deg, ${G.blue}, ${G.red}, ${G.yellow}, ${G.green})`,
                                    borderRadius: 2, opacity: 0.6,
                                }} />
                            </Box>
                            <Typography sx={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: '1rem', color: 'rgba(0,0,0,0.5)', fontWeight: 500, maxWidth: 500, mx: 'auto', mt: 2 }}>
                                Five simple steps from raw HR data to an actionable compliance report.
                            </Typography>
                        </Box>
                    </motion.div>
                    ...
                    <Box sx={{ position: 'relative' }}>
                        ...
                        {!IS_PERF_MODE && (
                            <Box sx={{
                                ...
                                background: `linear-gradient(90deg, ${G.blue}, ${G.green}, ${G.yellow}, ${G.red}, ${G.blue})`,
                        ...
                        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr', md: 'repeat(5,1fr)' }, gap: { xs: 3, md: 4 }, position: 'relative', zIndex: 1 }}>
                            {[
                                { icon: "📁", title: "Upload Data", text: "Upload CSV or link a Google Sheet.", color: G.blue, num: "01" },
                                { icon: "🔍", title: "Statistical Detection", text: "Engine runs AIR & chi-square tests.", color: G.green, num: "02" },
                                { icon: "🤖", title: "AI Analysis", text: "Gemini interprets statistical evidence.", color: G.yellow, num: "03" },
                                { icon: "🔄", title: "Simulate Fixes", text: "Toggle fixes & watch risk score drop.", color: G.red, num: "04" },
                                { icon: "📄", title: "Download Report", text: "Get board-ready compliance PDF.", color: G.blue, num: "05" },
                            ].map((step, i) => (
                                <motion.div key={step.num}
                                            ...
                                            style={{ height: '100%' }}>
                                    <TiltCard>
                                        <SpotlightCard color={step.color} borderRadius="28px">
                                            <Card elevation={0} sx={{
                                                p: 3, height: '100%', borderRadius: '28px', textAlign: 'center',
                                                border: '1.5px solid rgba(255,255,255,0.88)', background: 'rgba(255,255,255,0.86)',
                                                backdropFilter: 'blur(8px)',
                                                boxShadow: '0 6px 28px rgba(0,0,0,0.06)',
                                                transition: 'all 0.35s cubic-bezier(0.175,0.885,0.32,1.275)',
                                                position: 'relative', overflow: 'hidden', cursor: SHOW_CURSOR ? 'none' : 'auto',
                                                '&:hover': {
                                                    transform: 'translateY(-6px) scale(1.02)',
                                                    boxShadow: `0 24px 56px ${step.color}25, inset 0 0 28px ${step.color}07`,
                                                ...
                                                <Box sx={{
                                                    ...
                                                    borderRadius: '50%', background: `radial-gradient(circle, ${step.color}15, transparent)`,
                                                    filter: 'blur(15px)', transition: 'opacity 0.3s', opacity: 0,
                                                ...
                                                >
                                                    <Box sx={{
                                                        ...
                                                        background: '#fff', border: `2px solid ${step.color}20`,
                                                        boxShadow: `0 8px 24px ${step.color}25, inset 0 0 12px ${step.color}10`,
                                                        position: 'relative', transition: 'all 0.3s',
                                                        '.MuiCard-root:hover &': {
                                                            borderColor: step.color,
                                                            boxShadow: `0 12px 32px ${step.color}40, inset 0 0 16px ${step.color}20`,
                                                        }
                                                    }}>
                                                        {step.icon}
                                                        <Box sx={{
                                                ...
                                                <Typography sx={{ fontFamily: "'Syne',sans-serif", fontWeight: 900, fontSize: '1.15rem', mb: 1.2, color: '#202124', letterSpacing: '-0.02em', position: 'relative', zIndex: 2 }}>
                                                    {step.title}
                                                </Typography>
                                                <Typography sx={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: '0.88rem', color: 'rgba(0,0,0,0.55)', lineHeight: 1.6, fontWeight: 500, position: 'relative', zIndex: 2 }}>
                                                    {step.text}
                                                </Typography>
                                                ...
                                                <Box sx={{
                                                    ...
                                                    '.MuiCard-root:hover &': { opacity: 1, transform: 'scaleX(1)' }
                                                }} />
                                            </Card>
                                        </SpotlightCard>
                                    </TiltCard>
